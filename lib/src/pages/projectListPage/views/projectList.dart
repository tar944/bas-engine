...
typedef ProjectController = void Function(BuildContext context, void Function() methodOfProject);
...
class ProjectsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MVVM(
      ...
      viewModel: ProjectViewModel(onProjectActionCaller),
    );
  }
}
...
class _View extends StatelessView<ProjectViewModel> {
  ...
  Widget render(context, ProjectViewModel vm) {
    controller.call(context, vm.createProject);
            ...
            ? GridView(
                ...
                children: vm.projects
                    .map((item) => ProjectItem(
                        project: item, onActionCaller: vm.onProjectSelect))
                    .toList(),
              )
            : Column(
                children: [
